...
import ch.dboeckli.spring.restmvc.service.BeerOrderService;
...
public class BeerOrderController {
    ...
    public ResponseEntity<@NonNull Void> deleteBeerOrder(@PathVariable("beerOrderId") UUID beerOrderId) {
        log.info("deleteBeerOrder beerOrderId={}", beerOrderId);
