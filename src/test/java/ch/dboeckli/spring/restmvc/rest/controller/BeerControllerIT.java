...
import ch.dboeckli.spring.restmvc.repository.BeerOrderLinesRepository;
...
import static ch.dboeckli.spring.restmvc.service.BeerServiceJpaImpl.MAX_PAGE_SIZE;
...
class BeerControllerIT {
    ...
    void testListBeers() {
        ...
        assertAll(() -> {
            ...
            assertEquals(503, beersDtos.getTotalElements());
            assertEquals(21, beersDtos.getTotalPages());
    ...
    void testListBeersWithMaxPageSize() {
        ...
        assertAll(() -> {
            assert beersDtos != null;
            assertEquals(503, beersDtos.getTotalElements());
            assertEquals(6, beersDtos.getTotalPages());
    ...
    void testListBeerByName() {
        ...
        assertAll(() -> {
            assert beersDtos != null;
            assertEquals(60, beersDtos.getTotalElements());
        });
    }
    ...
    void testListBeerByNamePage2() {
        ...
        assertAll(() -> {
            ...
            assertEquals(2, beersDtos.getTotalPages());
            assertEquals(10, beersDtos.getNumberOfElements());
        });
    }
    ...
    void testListBeerByStyleAndBeerName() {
        ...
        assertAll(() -> {
            assert beersDtos != null;
            assertEquals(57, beersDtos.getTotalElements());
        });
    }
    ...
    void testListBeerByStyle() {
        ...
        assertAll(() -> {
            assert beersDtos != null;
            assertEquals(110, beersDtos.getTotalElements());
        });
    }
